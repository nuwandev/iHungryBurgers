 ...
 * @author TN_Master
 */
public class PreparingOrdersPanel extends javax.swing.JPanel {
     ...
     */
    public PreparingOrdersPanel(MainFrame mainFrame, OrderController orderController) {
        initComponents();
    ...
    private void reloadTable() {
        ...
        orderController.getOrdersByStatus(Order.PREPARING).forEach(order -> {
            model.addRow(new Object[]{order.getOrderID(), order.getCustomerID(), order.getCustomerName(), order.getQuantity(), order.getTotalPrice()});
            return true;
        });
    }
