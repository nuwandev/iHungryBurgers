...
public class UpdateOrderPanel extends javax.swing.JPanel {
     ...
     */
    public UpdateOrderPanel(MainFrame mainFrame, OrderController orderController) {
        initComponents();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!selectedOrder.getCustomerName().equals(txtName.getText())) {
            ...
            orderController.getOrderList().forEach(order -> {
                if (order.getCustomerID().equals(selectedOrder.getCustomerID())) {
        ...
        if (!needToUpdate) {
            ...
            StorageManager.refreshStorage(orderController.getOrderList());
            JOptionPane.showMessageDialog(
                    UpdateOrderPanel.this,
