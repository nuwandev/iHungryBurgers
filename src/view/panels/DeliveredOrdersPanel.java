...
public class DeliveredOrdersPanel extends javax.swing.JPanel {
     ...
     */
    public DeliveredOrdersPanel(MainFrame mainFrame, OrderController orderController) {
        initComponents();
    ...
    private void reloadTable() {
        ...
        orderController.getOrdersByStatus(Order.DELIVERED).forEach(order -> {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Delivered Orders");
